...
import minijuego.Ciudad4Minijuego;
...
public class Panel extends JPanel implements Runnable {
	...
	private void salidaConQ() {
		...
		if (admin.getEstado() == EstadoJuego.MENU_INSTRUCCIONES || admin.getEstado() == EstadoJuego.MAPA_GENERAL) {
	...
	private void actualizarMinijuegoActual() {
		...
		} else if (juego instanceof Ciudad4Minijuego) {
		    actualizarCiudad4((Ciudad4Minijuego) juego);
		}
	}
	...
	private void actualizarCiudad4(Ciudad4Minijuego c4) {
	    if (keyH.ultimoCaracter != 0) {
	        c4.procesarCaracter(keyH.ultimoCaracter);
	        keyH.ultimoCaracter = 0;
	    }
	}
